...
type GetUserStatisticResponse struct {
	...
	ThreadCreated int64 `protobuf:"varint,1,opt,name=thread_created,json=threadCreated,proto3" json:"thread_created,omitempty"`
	ThreadCracked int64 `protobuf:"varint,2,opt,name=thread_cracked,json=threadCracked,proto3" json:"thread_cracked,omitempty"`
}

func (x *GetUserStatisticResponse) Reset() {
	*x = GetUserStatisticResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetUserStatisticResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUserStatisticResponse) ProtoMessage() {}

func (x *GetUserStatisticResponse) ProtoReflect() protoreflect.Message {
	mi := &file_statistic_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetUserStatisticResponse.ProtoReflect.Descriptor instead.
func (*GetUserStatisticResponse) Descriptor() ([]byte, []int) {
	return file_statistic_proto_rawDescGZIP(), []int{4}
}

func (x *GetUserStatisticResponse) GetThreadCreated() int64 {
	if x != nil {
...
func (x *GetUserStatisticResponse) GetThreadCracked() int64 {
	if x != nil {
		return x.ThreadCracked
	}
	return 0
}
...
var file_statistic_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_statistic_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_statistic_proto_goTypes = []interface{}{
	...
	(*GetUserStatisticRequest)(nil),      // 3: traveller.GetUserStatisticRequest
	(*GetUserStatisticResponse)(nil),     // 4: traveller.GetUserStatisticResponse
	(*emptypb.Empty)(nil),                // 5: google.protobuf.Empty
}
var file_statistic_proto_depIdxs = []int32{
	5, // 0: traveller.StatisticService.GetTotalUser:input_type -> google.protobuf.Empty
	5, // 1: traveller.StatisticService.GetTotalSolvedThread:input_type -> google.protobuf.Empty
	5, // 2: traveller.StatisticService.GetTotalTraveler:input_type -> google.protobuf.Empty
	3, // 3: traveller.StatisticService.GetUserStatistic:input_type -> traveller.GetUserStatisticRequest
	0, // 4: traveller.StatisticService.GetTotalUser:output_type -> traveller.GetTotalUserResponse
	1, // 5: traveller.StatisticService.GetTotalSolvedThread:output_type -> traveller.GetTotalSolvedThreadResponse
	2, // 6: traveller.StatisticService.GetTotalTraveler:output_type -> traveller.GetTotalTravelerResponse
	4, // 7: traveller.StatisticService.GetUserStatistic:output_type -> traveller.GetUserStatisticResponse
...
func file_statistic_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_statistic_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetUserStatisticResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type StatisticServiceClient interface {
	...
	GetUserStatistic(ctx context.Context, in *GetUserStatisticRequest, opts ...grpc.CallOption) (*GetUserStatisticResponse, error)
}
...
func (c *statisticServiceClient) GetUserStatistic(ctx context.Context, in *GetUserStatisticRequest, opts ...grpc.CallOption) (*GetUserStatisticResponse, error) {
	out := new(GetUserStatisticResponse)
	err := c.cc.Invoke(ctx, "/traveller.StatisticService/GetUserStatistic", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StatisticServiceServer interface {
	...
	GetUserStatistic(context.Context, *GetUserStatisticRequest) (*GetUserStatisticResponse, error)
}
...
func (*UnimplementedStatisticServiceServer) GetUserStatistic(context.Context, *GetUserStatisticRequest) (*GetUserStatisticResponse, error) {
...
func _StatisticService_GetUserStatistic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserStatisticRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatisticServiceServer).GetUserStatistic(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/traveller.StatisticService/GetUserStatistic",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatisticServiceServer).GetUserStatistic(ctx, req.(*GetUserStatisticRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _StatisticService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _StatisticService_GetUserStatistic_Handler,
		},
	},
