...
var UserService = (function () {
  ...
  UserService.serviceName = "traveller.UserService";
  return UserService;
}());
...
UserService.GetAllUser = {
  ...
  responseType: user_pb.GetAllUserResponse
};
...
UserServiceClient.prototype.getAllUser = function getAllUser(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(UserService.GetAllUser, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
