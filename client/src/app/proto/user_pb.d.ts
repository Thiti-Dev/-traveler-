...
export class GetAllUserResponse extends jspb.Message {
  clearUsersList(): void;
  getUsersList(): Array<UserDetail>;
  setUsersList(value: Array<UserDetail>): void;
  addUsers(value?: UserDetail, index?: number): UserDetail;
...
export namespace GetAllUserResponse {
  export type AsObject = {
    usersList: Array<UserDetail.AsObject>,
  }
}
